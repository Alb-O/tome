...
result_handler!(RESULT_DUPLICATE_SELECTIONS_DOWN_HANDLERS, HANDLE_DUPLICATE_DOWN, "duplicate_down", |r, ctx, _| {
...
result_handler!(RESULT_DUPLICATE_SELECTIONS_UP_HANDLERS, HANDLE_DUPLICATE_UP, "duplicate_up", |r, ctx, _| {
...
result_handler!(RESULT_MERGE_SELECTIONS_HANDLERS, HANDLE_MERGE_SELECTIONS, "merge_selections", |r, ctx, _| {
