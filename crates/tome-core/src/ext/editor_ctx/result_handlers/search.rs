...
result_handler!(RESULT_SEARCH_NEXT_HANDLERS, HANDLE_SEARCH_NEXT, "search_next", |r, ctx, extend| {
...
result_handler!(RESULT_SEARCH_PREV_HANDLERS, HANDLE_SEARCH_PREV, "search_prev", |r, ctx, extend| {
...
result_handler!(RESULT_USE_SELECTION_SEARCH_HANDLERS, HANDLE_USE_SELECTION_AS_SEARCH, "use_selection_as_search", |_, ctx, _| {
