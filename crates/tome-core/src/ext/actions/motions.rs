...
motion_action!(action_move_line_start, "move_line_start", "move_line_start", "Move to line start");
motion_action!(action_move_line_end, "move_line_end", "move_line_end", "Move to line end");
motion_action!(action_move_first_nonblank, "move_first_nonblank", "move_first_nonblank", "Move to first non-blank");
