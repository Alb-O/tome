...
static NOTIF_ACP_STARTING: NotificationDef =
	NotificationDef::new("acp_starting", Level::Info, AutoDismiss::DEFAULT, RegistrySource::Builtin);

#[distributed_slice(NOTIFICATIONS)]
static NOTIF_ACP_STOPPED: NotificationDef =
	NotificationDef::new("acp_stopped", Level::Info, AutoDismiss::DEFAULT, RegistrySource::Builtin);

#[distributed_slice(NOTIFICATIONS)]
static NOTIF_ACP_CANCELLED: NotificationDef =
	NotificationDef::new("acp_cancelled", Level::Info, AutoDismiss::DEFAULT, RegistrySource::Builtin);

#[distributed_slice(NOTIFICATIONS)]
static NOTIF_ACP_MODEL_SET: NotificationDef =
	NotificationDef::new("acp_model_set", Level::Info, AutoDismiss::DEFAULT, RegistrySource::Builtin);

#[distributed_slice(NOTIFICATIONS)]
static NOTIF_ACP_MODEL_INFO: NotificationDef =
	NotificationDef::new("acp_model_info", Level::Info, AutoDismiss::Never, RegistrySource::Builtin);
