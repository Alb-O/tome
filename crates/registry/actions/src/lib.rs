...
pub use result::{
	...
	RESULT_CLOSE_OTHER_BUFFERS_HANDLERS, RESULT_CLOSE_PALETTE_HANDLERS, RESULT_CLOSE_SPLIT_HANDLERS,
	RESULT_COMMAND_HANDLERS, RESULT_CURSOR_MOVE_HANDLERS, RESULT_EDIT_HANDLERS,
	RESULT_ERROR_HANDLERS, RESULT_EXECUTE_PALETTE_HANDLERS, RESULT_EXTENSION_HANDLERS,
	...
	RESULT_OPEN_PALETTE_HANDLERS, RESULT_PENDING_HANDLERS, RESULT_QUIT_HANDLERS,
