...
#[rstest]
#[case::a(vec![(0, 25), (25, 25)], vec![Length(25), Length(25)])]
#[case::b(vec![(0, 25), (25, 25)], vec![Length(25), Percentage(25)])]
#[case::c(vec![(0, 25), (25, 25)], vec![Percentage(25), Length(25)])]
...
#[case::j(vec![(0, 25), (25, 25)], vec![Max(25), Percentage(25)])]
#[case::k(vec![(0, 25), (25, 25)], vec![Percentage(25), Max(25)])]
#[case::l(vec![(0, 25), (25, 25)], vec![Length(25), Ratio(1, 4)])]
#[case::m(vec![(0, 25), (25, 25)], vec![Ratio(1, 4), Length(25)])]
#[case::n(vec![(0, 25), (25, 25)], vec![Percentage(25), Ratio(1, 4)])]
#[case::o(vec![(0, 25), (25, 25)], vec![Ratio(1, 4), Percentage(25)])]
