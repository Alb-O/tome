...
use super::client::create_api_key;
use super::client::exchange_code_for_tokens;
use super::constants::AUTHORIZE_URL_CONSOLE;
use super::constants::AUTHORIZE_URL_MAX;
use super::constants::CLIENT_ID;
use super::constants::REDIRECT_URI;
...
pub async fn complete_login(session: &LoginSession, code: &str) -> AuthResult<()> {
    ...
    let state = match session.mode {
        LoginMode::Max => AuthState::from_oauth(
            tokens.access_token,
