//! RegistryMetadata implementation for TextObjectDef.
//!
//! This bridges the registry's TextObjectDef type to manifest's RegistryMetadata trait.

use evildoer_registry::text_objects::TextObjectDef;

impl crate::RegistryMetadata for TextObjectDef {
